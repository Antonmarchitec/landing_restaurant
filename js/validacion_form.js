...
function validar(){
    ...
    let campoCorreo = document.querySelector("#correo").value
    let campoNombre = document.querySelector("#name").value
    ...
    if( campoNombre === "" || campoCorreo === ""){
        ...
        Swal.fire({
            ...
            background:"rgb(12, 20, 59)",   //fondo de la ventana
            //color:'white',
        ...
        Swal.fire({
            title:"<h2> ¡Ingresar max 30 caracteres! <h2>",    //tilte si se acepta codigo html
        ...
        return false
    }else if(!expresionRegular.test(campoCorreo)){
